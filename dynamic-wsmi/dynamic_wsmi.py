...
def computeWSMI(file_to_compute, word_to_compute, output_path, sample_rate, channels, samples_per_trial, tau, total_time, window_size, window_offset, healthyData):
    ...
    for i in range(0,N_WINDOWS):
        #start clock to evaluate realtime analysis
        start_clock_window = time.process_time()
        ...
        print("Window finished in ", time.process_time() - start_clock_window, " sec")
