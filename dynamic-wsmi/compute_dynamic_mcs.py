...
for subject in files:
    ...
    computeWSMI(
        ...
        output_path='../examples/dataset/realtime-wsmi/MCS',
        sample_rate=250,
        channels=128,
    ...
    f = open("progress_mcs.txt", "a").write(subject_filename + ',')