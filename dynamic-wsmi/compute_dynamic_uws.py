...
for subject in files:
    ...
    computeWSMI(
        ...
        output_path='../examples/dataset/realtime-wsmi/UWS',
        sample_rate=250,
        channels=128,
    ...
    f = open("progress_uws.txt", "a").write(subject_filename + ',')